...
metadata = {"state_description": "scheduling",
            ...
            "image_ref_url": "http://10.20.0.6:9292/images/146e9b37-c922-45c6-9d7d-477fec54bc59",
            "root_gb": 1,
            ...
            "image_meta": {"container_format": "bare",
                           "min_ram": "64",
                           "murano_image_info": "{\"title\": \"Murano Demo\", \"type\": \"cirros.demo\"}",
                           "disk_format": "qcow2",
                           "min_disk": "1",
                           "base_image_ref": "146e9b37-c922-45c6-9d7d-477fec54bc59"},
            "architecture": None, "os_type": None,
            "instance_flavor_id": "5306"}

sample_dict = {"counter_name": "instance",
               "user_id": "ba597f03542d4609bda1698b25222dc2",
               "message_signature": "c8f7c5a127931cd7cc7a99d24f51751a46ab343a2cba246a613e8c56644500a1",
...
def record_samples(samples_count=50000, resources_count=5000,
    ...
    for resource, timestamps in resources_timestamps.items():
        resource_dict = {"_id": resource,
                         ...
                         "last_sample_timestamp": timestamps[0] + datetime.timedelta(seconds=random.randint(0, 1000)),
                         "metadata": resource_metadatas[resource],
                         "user_id": conf.get('user'),
                         "project_id": conf.get('project'),
                         "source": "jira",
                         "meter": [{"counter_name": conf.get('name', 'cpu_util'),
